...
<h1 align="center">Optimus Prime TUI</h1>
...
```typescript
import { TUI, Text, Editor, ProcessTerminal, matchesKey } from "optimus-tui";
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "optimus-tui";
...
```typescript
import { Container, type Focusable, Input } from "optimus-tui";
...
Renders Kitty or iTerm2 terminal graphics when supported. Set `fallbackOnly: true` to show compact image metadata instead; Optimus Prime uses this metadata-only mode.
...
```typescript
import { CombinedAutocompleteProvider } from "optimus-tui";
...
```typescript
import { matchesKey, Key } from "optimus-tui";
...
```typescript
import { visibleWidth, truncateToWidth, wrapTextWithAnsi } from "optimus-tui";
...
```typescript
import { matchesKey, Key, truncateToWidth } from "optimus-tui";
import type { Component } from "optimus-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "optimus-tui";
import type { Component } from "optimus-tui";
