...
export const MODELS = {
	...
	"grok": {
		"grok-4.20-0309-non-reasoning": {
			...
			maxTokens: 16384,
		} satisfies Model<"grok-responses">,
	...
	"nous": {
		...
		"deepseek/deepseek-v3.2": {
			...
			input: ["text"],
			cost: {
				input: 0.20800000000000002,
				output: 0.30400000000000005,
		...
		"deepseek/deepseek-v4-flash": {
			...
			input: ["text"],
			cost: {
				input: 0.051399999999999994,
				output: 0.10279999999999999,
				cacheRead: 0.0103,
				cacheWrite: 0,
			},
			contextWindow: 1048576,
		...
		"deepseek/deepseek-v4-pro": {
			...
			input: ["text"],
			cost: {
				input: 0.33099999999999996,
				output: 0.6619999999999999,
				cacheRead: 0.0276,
				cacheWrite: 0,
			},
			contextWindow: 1048576,
		...
		"openai/gpt-5.2-pro": {
			...
			input: ["text", "image"],
			cost: {
				input: 16.799999999999997,
				output: 134.39999999999998,
				cacheRead: 0,
				cacheWrite: 0,
			},
			contextWindow: 400000,
		...
		"qwen/qwen-plus": {
			...
			cost: {
				input: 0.20800000000000002,
				output: 0.624,
				cacheRead: 0.041600000000000005,
				cacheWrite: 0,
			},
			contextWindow: 1000000,
			maxTokens: 32768,
		...
		"qwen/qwen3-coder-flash": {
			...
			cost: {
				input: 0.156,
				output: 0.78,
				cacheRead: 0.031200000000000002,
				cacheWrite: 0,
			},
			contextWindow: 1000000,
			maxTokens: 65536,
		...
		"qwen/qwen3-vl-32b-instruct": {
			...
			input: ["text", "image"],
			cost: {
				input: 0.08320000000000001,
				output: 0.33280000000000004,
				cacheRead: 0,
				cacheWrite: 0,
			},
			contextWindow: 131072,
		...
		"qwen/qwen3.5-flash-02-23": {
			...
			input: ["text", "image"],
			cost: {
				input: 0.052000000000000005,
				output: 0.20800000000000002,
				cacheRead: 0,
				cacheWrite: 0,
			},
			contextWindow: 1000000,
		...
		"xiaomi/mimo-v2.5": {
			...
			cost: {
				input: 0.112,
				output: 0.224,
				cacheRead: 0.0021999999999999997,
				cacheWrite: 0,
			},
			contextWindow: 1050000,
			maxTokens: 131072,
	...
	"openrouter": {
		...
		"deepseek/deepseek-v4-flash": {
			...
			provider: "openrouter",
			baseUrl: "https://openrouter.ai/api/v1",
			compat: {"requiresReasoningContentOnAssistantMessages":true,"thinkingFormat":"openrouter"},
			reasoning: true,
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null,"high":"high","xhigh":"max","max":null},
			input: ["text"],
			cost: {
