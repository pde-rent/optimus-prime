 ...
 * in the system prompt. The agent can then use the repl tool to load
...
When working on tasks related to these rules, use the repl tool to load the relevant rule files for guidance.
`,
		};
	});
}
