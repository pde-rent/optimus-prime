...
| js | A markdown skill that also ships a `skill.js` module preloaded into the agent's persistent REPL | Capabilities that are naturally one call: API wrappers, fetchers, converters, computations |

Before writing a JS-backed skill, read [references/js-skills.md](references/js-skills.md) for the module contract.
...
For JS-backed skills, also run the checks in [references/js-skills.md](references/js-skills.md).
