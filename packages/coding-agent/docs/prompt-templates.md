> Optimus Prime can create prompt templates. Ask it to build one for your workflow.
...
Optimus Prime loads prompt templates from:

- Global: `~/.optimus/agent/prompts/*.md`
- Project: `.optimus/agent/prompts/*.md`
