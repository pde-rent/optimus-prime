...
const DEFAULT_OPTIMUS_DOWNLOAD_BASE_URL = "https://pub-728493de92a943e2a9b2d17b4719f318.r2.dev";
...
function getOptimusDownloadBaseUrl(): string {
	return (process.env.OPTIMUS_DOWNLOAD_BASE_URL?.trim() || DEFAULT_OPTIMUS_DOWNLOAD_BASE_URL).replace(/\/+$/, "");
}
...
export async function getLatestPiRelease(
	...
	const baseUrl = getOptimusDownloadBaseUrl();
