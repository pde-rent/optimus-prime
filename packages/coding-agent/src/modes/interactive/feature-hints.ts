...
export const FEATURE_HINTS: readonly FeatureHintDefinition[] = [
	...
	{
		id: "subagents",
		getText: () => "Optimus Prime can delegate tasks to subagents and run them in parallel.",
	},
	{
		id: "agents-view",
		getText: ({ getKeybinding, isResidentSession }) => {
			...
			return key ? `Hit ${key} for Session View: search running, done, and archived sessions.` : undefined;
		},
	},
	{
		id: "session-rewind",
	...
	{
		id: "auto-compaction",
		getText: () => "Optimus Prime automatically compacts long sessions before context fills up.",
	},
	{
		id: "auto-refine",
		getText: () => "Optimus Prime self-improves by refining skills, memories, prompts, subagents.",
	},
	{
