...
| Responses-wire stream skeleton | createResponsesWireStream (was 3 copies in openai-responses/grok/azure) | ai/providers | request assembly stays per provider; hooks/retry/request-id/scratch keys owned by factory | providers/responses-wire.ts | low | DONE 6b9591081; completions-family skeleton (openai-completions/mistral/cursor) is a DIFFERENT wire - separate audit if attempted |
